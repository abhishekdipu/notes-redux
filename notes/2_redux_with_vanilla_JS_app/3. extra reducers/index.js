...
store.dispatch(buyCake()); // current state { cake: { numOfCakes: 9 }, icecream: { numOfIcecream: 19 } }
store.dispatch(buyCake()); // current state { cake: { numOfCakes: 8 }, icecream: { numOfIcecream: 19 } }
store.dispatch(buyIcecream()); // current state { cake: { numOfCakes: 8 }, icecream: { numOfIcecream: 18 } }
store.dispatch(buyIcecream()); // current state { cake: { numOfCakes: 8 }, icecream: { numOfIcecream: 17 } }
